...
namespace Plugin {
    ...
    static const uint16 NTPPort = 123;
    ...
    /* virtual */ const string TimeSync::Initialize(PluginHost::IShell* service)
    {
        ...
        _sink.Initialize(service, _client, config.System.Value());
    ...
    TimeSync::Process(const Web::Request& request)
    {
        ...
        if (request.Verb == Web::Request::HTTP_GET) {
            ...
            uint64 syncTime(_client->SyncTime());
    ...
    void TimeSync::SyncedTime(const uint64 time)
    {

...
namespace Plugin {
    ...
    public:
        ...
        public:
            ...
            Data(const string& name, const state actualState, const uint32 index, const string& label)
                : Core::JSON::Container()
            {
                Add(_T("sequencer"), &Sequencer);
                Add(_T("state"), &State);
    ...
    private:
        ...
        public:
            ...
            inline uint32 Index() const
            {
                ...
                uint32 result = static_cast<uint32>(~0);
            ...
            uint32 Load(const Core::JSON::ArrayType<Command>& commandList)
            {

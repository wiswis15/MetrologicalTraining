...
namespace Plugin {
    ...
    static Core::ProxyPoolType<Web::JSONBodyType<OutOfProcessTest::Data> > jsonBodyDataFactory(4);
    ...
    /* virtual */ void OutOfProcessTest::Inbound(Web::Request& request)
    {
    ...
    /* virtual */ Core::ProxyType<Web::Response> OutOfProcessTest::Process(const Web::Request& request)
    {

 ...
 *
 */
    void SHA1::Input(const uint8 message_array[], const uint16 length)
    {
        uint16 counter = length;
        const uint8* current = &(message_array[0]);
 ...
 *
 */
    SHA1& SHA1::operator<<(const uint8 message_array[])
    {
        const uint8* p = &(message_array[0]);
 ...
 *
 */
    SHA1& SHA1::operator<<(const uint8 message_element)
    {
 ...
 *      stored in the _messageBlock array.
 *
 *  Parameters:
 *      None.
 *
 ...
 */
     ...
     */
        ...
        uint32* writer = reinterpret_cast<uint32*>(&_messageBlock[0]);

        for (uint8 teller = 0; teller < 5; teller++) {
 ...
 */
    ...
    void MD5::CloseContext()
    {
        ...
        memset(&_context.buffer[used], 0, available - 8);

        _context.lo <<= 3;
        _context.buffer[56] = _context.lo;
        _context.buffer[57] = _context.lo >> 8;
        _context.buffer[58] = _context.lo >> 16;
        _context.buffer[59] = _context.lo >> 24;
        _context.buffer[60] = _context.hi;
        _context.buffer[61] = _context.hi >> 8;
        _context.buffer[62] = _context.hi >> 16;
        _context.buffer[63] = _context.hi >> 24;

        body(&_context, _context.buffer, 64);

        _context.buffer[0] = _context.a;
        _context.buffer[1] = _context.a >> 8;
        _context.buffer[2] = _context.a >> 16;
        _context.buffer[3] = _context.a >> 24;
        _context.buffer[4] = _context.b;
        _context.buffer[5] = _context.b >> 8;
        _context.buffer[6] = _context.b >> 16;
        _context.buffer[7] = _context.b >> 24;
        _context.buffer[8] = _context.c;
        _context.buffer[9] = _context.c >> 8;
        _context.buffer[10] = _context.c >> 16;
        _context.buffer[11] = _context.c >> 24;
        _context.buffer[12] = _context.d;
        _context.buffer[13] = _context.d >> 8;
        _context.buffer[14] = _context.d >> 16;
        _context.buffer[15] = _context.d >> 24;
    }

    void MD5::Input(const uint8 message_array[], const uint16 length)
    {
        uint16 sizeToHandle = length;
        const uint8* source = &message_array[0];
 ...
 *
 */
    MD5& MD5::operator<<(const uint8 message_array[])
    {
        uint16 length = 0;
 ...
 *
 */
    MD5& MD5::operator<<(const uint8 message_element)
    {
        Input(&message_element, 1);
    ...
    void SHA256::Input(const uint8 message_array[], const uint16 length)
    {
        uint16 sizeToHandle = length;
        const uint8* source = &message_array[0];
 ...
 *
 */
    SHA256& SHA256::operator<<(const uint8 message_array[])
    {
        uint16 length = 0;
 ...
 *
 */
    SHA256& SHA256::operator<<(const uint8 message_element)
    {
        Input(&message_element, 1);
    ...
    static void sha224_update(SHA256::Context* ctx, const unsigned char* message, unsigned int len)
    {
        unsigned int block_nb;
        unsigned int new_len, rem_len, tmp_len;
        const unsigned char* shifted_message;
    ...
    void SHA224::Input(const uint8 message_array[], const uint16 length)
    {
        uint16 sizeToHandle = length;
        const uint8* source = &message_array[0];
 ...
 *
 */
    SHA224& SHA224::operator<<(const uint8 message_array[])
    {
        uint16 length = 0;
 ...
 *
 */
    SHA224& SHA224::operator<<(const uint8 message_element)
    {
        Input(&message_element, 1);
    ...
    void SHA512::Input(const uint8 message_array[], const uint16 length)
    {
        uint16 sizeToHandle = length;
        const uint8* source = &message_array[0];
 ...
 *
 */
    SHA512& SHA512::operator<<(const uint8 message_array[])
    {
        uint16 length = 0;
 ...
 *
 */
    SHA512& SHA512::operator<<(const uint8 message_element)
    {
        Input(&message_element, 1);
    ...
    static void sha384_update(SHA512::Context* ctx, const unsigned char* message, unsigned int len)
    {
        unsigned int block_nb;
        unsigned int new_len, rem_len, tmp_len;
        const unsigned char* shifted_message;
    ...
    void SHA384::Input(const uint8 message_array[], const uint16 length)
    {
        uint16 sizeToHandle = length;
        const uint8* source = &message_array[0];
 ...
 *
 */
    SHA384& SHA384::operator<<(const uint8 message_array[])
    {
        uint16 length = 0;
 ...
 *
 */
    SHA384& SHA384::operator<<(const uint8 message_element)
    {
        Input(&message_element, 1);

...
namespace Web {
    ...
    public:
        inline SingleElementFactoryType(const uint8 /* queuSize */)
        {
    ...
    private:
        ...
        private:
            static const uint32 ELEMENTFACTORY_QUEUESIZE = 1;
...
#pragma warning(default : 4355)
    ...
    public:
        ...
        uint32 Upload(const Core::URL& destination, const Core::File& source)
        {
        ...
        uint32 Download(const Core::URL& source, Core::File& destination)
        {
            uint32 result = Core::ERROR_INPROGRESS;
        ...
        virtual void Transfered(const uint32 result, const FILEBODY& file) = 0;

    private:
        inline void EndTransfer(const Core::ProxyType<Web::Response>& response)
        {
            uint32 errorCode = Core::ERROR_NONE;
    ...
    private:
        ...
        typedef hasSerializedHashValue<FILEBODY, const uint8* (FILEBODY::*)() const> TraitSerializedHashValue;
        typedef hasDeserializedHashValue<FILEBODY, const uint8* (FILEBODY::*)() const> TraitDeserializedHashValue;

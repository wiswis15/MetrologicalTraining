...
namespace Web {
    namespace WebSocket {
        ...
        public:
            ...
            uint16 Encoder(uint8* dataFrame, const uint16 maxSendSize, const uint16 usedSize);
            uint16 Decoder(uint8* dataFrame, uint16& receivedSize);

        private:
            uint8 _setFlags;
            uint8 _progressInfo;
            uint32 _pendingReceiveBytes;
            frameType _frameType;
            uint8 _scrambleKey[4];
            uint8 _controlStatus;
        };
    ...
    private:
        ...
        private:
            ...
            public:
                SerializerImpl(ThisClass& parent, const uint8 queueSize)
                    : OUTBOUND::Serializer()
                    , _parent(parent)
                    , _adminLock()
                    , _queue(queueSize)
            ...
            public:
                ...
                inline uint16 Serialize(uint8 stream[], const uint16 maxLength)
                {
            ...
            public:
                DeserializerImpl(ThisClass& parent, const uint8 queueSize)
        ...
        public:
            ...
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1)
                : ACTUALLINK(arg1)
            ...
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2)
            ...
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3)
            ...
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
            ...
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
            ...
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6)
            ...
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6, Arg7 arg7)
            ...
            template <typename Arg1>
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1)
                : ACTUALLINK(arg1)
                , _handler(binary, masking)
                , _parent(parent)
                , _adminLock()
            ...
            template <typename Arg1, typename Arg2>
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2)
                : ACTUALLINK(arg1, arg2)
                , _handler(binary, masking)
                , _parent(parent)
                , _adminLock()
            ...
            template <typename Arg1, typename Arg2, typename Arg3>
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3)
                : ACTUALLINK(arg1, arg2, arg3)
                , _handler(binary, masking)
                , _parent(parent)
                , _adminLock()
            ...
            template <typename Arg1, typename Arg2, typename Arg3, typename Arg4>
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
                : ACTUALLINK(arg1, arg2, arg3, arg4)
                , _handler(binary, masking)
                , _parent(parent)
                , _adminLock()
            ...
            template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5>
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
                : ACTUALLINK(arg1, arg2, arg3, arg4, arg5)
                , _handler(binary, masking)
                , _parent(parent)
                , _adminLock()
            ...
            template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5, typename Arg6, typename Arg7>
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6)
                : ACTUALLINK(arg1, arg2, arg3, arg4, arg5, arg6)
                , _handler(binary, masking)
                , _parent(parent)
                , _adminLock()
            ...
            template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5, typename Arg6, typename Arg7>
            HandlerType(ParentClass& parent, const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6, Arg7 arg7)
                : ACTUALLINK(arg1, arg2, arg3, arg4, arg5, arg6, arg7)
                , _handler(binary, masking)
                , _parent(parent)
                , _adminLock()
            ...
            virtual uint16 ReceiveData(uint8* dataFrame, const uint16 receivedSize)
            {
                ...
                if ((_state & WEBSOCKET) != 0) {
                    ...
                    while ((result < receivedSize) && (tooSmall == false)) {
                        uint16 actualDataSize = receivedSize - result;
                        uint16 headerSize = _handler.Decoder(const_cast<uint8*>(&dataFrame[result]), actualDataSize);
                            ...
                            if ((_handler.FrameType() & 0xF0) != 0) {
                                ...
                                if (_handler.IsCompleteMessage() == true) {
                                    ...
                                    if (_handler.FrameType() == WebSocket::Protocol::PING) {
                                        ...
                                        if (_pingFireTime != 0) {
                                            TRACE_L1("Ping acknowledged by a pong in %d (uS)", static_cast<uint32>(static_cast<uint64>(Core::Time::Now().Ticks() - _pingFireTime)));
                                            _pingFireTime = 0;
                                        }
                                        else {
        ...
        private:
            inline uint32 CheckForClose(uint32 waitTime)
            {
                uint32 result = 0;
                ...
                if ((IsSuspended() == true) && (_serializerImpl.IsIdle() == true) && (_deserialiserImpl.IsIdle() == true) && (_parent.IsIdle() == true)) {
                    ...
                    while (waitTime > 0) {
                        uint32 sleepTime = (waitTime > 100 ? 100 : waitTime);
...
#endif
        template <typename Arg1>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1)
            : _channel(*this, binary, masking, queueSize, arg1)
        {
        }
        template <typename Arg1, typename Arg2>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2)
            : _channel(*this, binary, masking, queueSize, arg1, arg2)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3)
            : _channel(*this, binary, masking, queueSize, arg1, arg2, arg3)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
            : _channel(*this, binary, masking, queueSize, arg1, arg2, arg3, arg4)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
            : _channel(*this, binary, masking, queueSize, arg1, arg2, arg3, arg4, arg5)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5, typename Arg6>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6)
            : _channel(*this, binary, masking, queueSize, arg1, arg2, arg3, arg4, arg5, arg6)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5, typename Arg6, typename Arg7>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6, Arg7 arg7)
            : _channel(*this, binary, masking, queueSize, arg1, arg2, arg3, arg4, arg5, arg6, arg7)
        {
        }
        template <typename Arg1>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1)
            : _channel(*this, binary, masking, queueSize, allocator, arg1)
        {
        }
        template <typename Arg1, typename Arg2>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2)
            : _channel(*this, binary, masking, queueSize, allocator, arg1, arg2)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3)
            : _channel(*this, binary, masking, queueSize, allocator, arg1, arg2, arg3)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
            : _channel(*this, binary, masking, queueSize, allocator, arg1, arg2, arg3, arg4)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
            : _channel(*this, binary, masking, queueSize, allocator, arg1, arg2, arg3, arg4, arg5)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5, typename Arg6>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6)
            : _channel(*this, binary, masking, queueSize, allocator, arg1, arg2, arg3, arg4, arg5, arg6)
        {
        }
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5, typename Arg6, typename Arg7>
        WebSocketLinkType(const bool binary, const bool masking, const uint8 queueSize, ALLOCATOR allocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5, Arg6 arg6, Arg7 arg7)

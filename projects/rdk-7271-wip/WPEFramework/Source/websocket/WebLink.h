...
#pragma warning(disable : 4355)
#endif
        template <typename Arg1>
        WebLinkType(const uint8 queueSize, Arg1 arg1)
        ...
        template <typename Arg1, typename Arg2>
        WebLinkType(const uint8 queueSize, Arg1 arg1, Arg2 arg2)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, queueSize)
        ...
        template <typename Arg1, typename Arg2, typename Arg3>
        WebLinkType(const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, queueSize)
        ...
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4>
        WebLinkType(const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, queueSize)
        ...
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5>
        WebLinkType(const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, queueSize)
        ...
        template <typename Arg1>
        WebLinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1)
            : _serializerImpl(*this, queueSize)
        ...
        template <typename Arg1, typename Arg2>
        WebLinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1, Arg2 arg2)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, responseAllocator)
            , _channel(*this, arg1, arg2)
        {
        ...
        template <typename Arg1, typename Arg2, typename Arg3>
        WebLinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1, Arg2 arg2, Arg3 arg3)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, responseAllocator)
            , _channel(*this, arg1, arg2, arg3)
        {
        ...
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4>
        WebLinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, responseAllocator)
            , _channel(*this, arg1, arg2, arg3, arg4)
        {
        ...
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5>
        WebLinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, responseAllocator)
            , _channel(*this, arg1, arg2, arg3, arg4, arg5)
        {
...
#pragma warning(default : 4355)
    ...
    private:
        ...
        typedef hasTransform<TRANSFORM, uint16 (TRANSFORM::*)(BaseDeserializer&, uint8* data, const uint16 maxSize)> TraitDeserializer;
        typedef hasTransform<TRANSFORM, uint16 (TRANSFORM::*)(BaseSerializer&, uint8* data, const uint16 maxSize)> TraitSerializer;

        template <typename CLASSNAME>
        inline typename Core::TypeTraits::enable_if<CLASSNAME::TraitDeserializer::value, uint16>::type
        ReceiveData(const CLASSNAME&, uint8* dataFrame, const uint16 receivedSize)
        {
        ...
        template <typename CLASSNAME>
        inline typename Core::TypeTraits::enable_if<CLASSNAME::TraitSerializer::value, uint16>::type
        SendData(const CLASSNAME&, uint8* dataFrame, const uint16 receivedSize)
        {

...
namespace Core {
    ...
    public:
        ...
        static uint16 Encode(const TCHAR* source, const uint16 sourceLength, TCHAR* destination, const uint16 destinationLength);
        static uint16 Decode(const TCHAR* source, const uint16 sourceLength, TCHAR* destination, const uint16 destinationLength);

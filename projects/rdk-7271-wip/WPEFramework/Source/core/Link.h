...
#pragma warning(disable : 4355)
#endif
        template <typename Arg1>
        LinkType(const uint8 queueSize, Arg1 arg1)
        ...
        template <typename Arg1, typename Arg2>
        LinkType(const uint8 queueSize, Arg1 arg1, Arg2 arg2)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, queueSize)
        ...
        template <typename Arg1, typename Arg2, typename Arg3>
        LinkType(const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, queueSize)
        ...
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4>
        LinkType(const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, queueSize)
        ...
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5>
        LinkType(const uint8 queueSize, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, queueSize)
        ...
        template <typename Arg1>
        LinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1)
            : _serializerImpl(*this, queueSize)
        ...
        template <typename Arg1, typename Arg2>
        LinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1, Arg2 arg2)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, responseAllocator)
            , _channel(*this, arg1, arg2)
        {
        ...
        template <typename Arg1, typename Arg2, typename Arg3>
        LinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1, Arg2 arg2, Arg3 arg3)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, responseAllocator)
            , _channel(*this, arg1, arg2, arg3)
        {
        ...
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4>
        LinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, responseAllocator)
            , _channel(*this, arg1, arg2, arg3, arg4)
        {
        ...
        template <typename Arg1, typename Arg2, typename Arg3, typename Arg4, typename Arg5>
        LinkType(const uint8 queueSize, ALLOCATOR responseAllocator, Arg1 arg1, Arg2 arg2, Arg3 arg3, Arg4 arg4, Arg5 arg5)
            : _serializerImpl(*this, queueSize)
            , _deserialiserImpl(*this, responseAllocator)
            , _channel(*this, arg1, arg2, arg3, arg4, arg5)
        {

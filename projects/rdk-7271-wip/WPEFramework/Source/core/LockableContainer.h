...
namespace Core {
    ...
    public:
        bool ReadLock(const uint32 waitTime = Core::infinite) const
        {
        ...
        bool WriteLock(const uint32 waitTime = Core::infinite) const
        {

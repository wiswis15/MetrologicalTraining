...
namespace Core {
    ...
    public:
        ...
        inline TextFragment ClassName(const char name[])
        {
            ...
            uint16 index = 0;
            uint16 lastIndex = static_cast<uint16>(~0);
    ...
    {
        uint16 index = static_cast<uint16>(strlen(fileName));
        bool found = false;
    ...
    string LogMessage(const TCHAR fileName[], const uint32 lineNumber, const TCHAR* message)
    {
#ifdef _UNICODE

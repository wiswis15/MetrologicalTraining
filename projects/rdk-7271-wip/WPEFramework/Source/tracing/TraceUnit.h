...
namespace Trace {
    ...
    private:
		...
		public:
			...
			virtual uint32 GetOverwriteSize(Cursor& cursor) override;
    ...
    public:
        ...
        uint32 Open (const string& pathName);
        uint32 Close ();
        ...
        void Trace(const char fileName[], const uint32 lineNumber, const char className[], const ITrace* const information);

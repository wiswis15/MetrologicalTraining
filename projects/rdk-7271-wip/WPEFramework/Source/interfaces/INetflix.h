...
namespace Exchange {
    ...
    struct INetflix : virtual public Core::IUnknown {
        ...
        // There might be dependencies on which Netflix should wait,
        // like hardware :-) or provisioning before it can continue 
        // to start through. If all conditions have been met, Netflix 
        // will be GO !!!
        virtual void Go() = 0;

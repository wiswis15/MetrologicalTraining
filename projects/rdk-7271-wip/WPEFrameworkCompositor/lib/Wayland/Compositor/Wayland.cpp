...
namespace Plugin {
    ...
    private:
        ...
        public:
            static Entry* Create(Implementation::IServer* server, Wayland::Display* display, const uint32 id)
            {
    ...
    public:
        /* virtual */ uint32 Configure(const string& info)
        {
            _config.FromString(info);
            ...
            _server = Implementation::Create(info);

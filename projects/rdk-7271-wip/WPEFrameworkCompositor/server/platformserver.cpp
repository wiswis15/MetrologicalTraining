...
int main(int argc, char* argv[])
{
    ...
    resourceCenter = Core::ServiceAdministrator::Instance().Instantiate<Exchange::IResourceCenter>(resource, _T("PlatformImplementation"), static_cast<uint32>(~0));
    if (resourceCenter) {
    ...
    uint32 confResult = resourceCenter->Configure("{}");

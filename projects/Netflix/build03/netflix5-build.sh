...
export EXTRA_CONF_ARGS='-DNRDP_HAS_AUDIOMIXER=OFF -DDPI_IMPLEMENTATION=reference -DDPI_REFERENCE_DRM=playready2.5-ss-tee-install-prefix -DNETFLIX5_SEARCH_INSTALL_PREFIX=ON -DNETFLIX_USE_PROVISION=OFF'

...
export EXTRA_CONF_ARGS='-DNRDP_HAS_AUDIOMIXER=OFF -DDPI_IMPLEMENTATION=reference -DDPI_REFERENCE_DRM=none -DNETFLIX5_SEARCH_INSTALL_PREFIX=ON -DNETFLIX_USE_PROVISION=OFF -DDPI_REFERENCE_TTS=none -DBUILD_SIGNUP=OFF -DDPI_SINK_INTERFACE_OVERRIDE_APPBOOT=OFF -DNRDP_CRASH_REPORTING=off -DDPI_DRM=none -DJS_MINIFY=OFF'

...
namespace Plugin {
    ...
    class OutOfProcessTest : public PluginHost::IPlugin, public PluginHost::IWeb {
    private:
        OutOfProcessTest(const OutOfProcessTest&);
        OutOfProcessTest& operator=(const OutOfProcessTest&);
        ...
        public:
			explicit Notification(OutOfProcessTest* parent)
				: _parent(*parent)
            {
    ...
    public:
        BEGIN_INTERFACE_MAP(OutOfProcessTest)

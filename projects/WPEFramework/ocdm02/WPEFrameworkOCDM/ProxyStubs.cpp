...
namespace WPEFramework {
    ...
    ProxyStub::MethodHandler CallbackStubMethods[] = {
        [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED, Core::ProxyType<RPC::InvokeMessage>& message) {
            fprintf(stderr, "%s:%d ProcessChallenge\n", __FILE__, __LINE__);
        	//
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader parameters(message->Parameters().Reader());
            const uint8_t* keyId = nullptr;
            uint8_t length = parameters.LockBuffer<uint8_t>(keyId);
    ...
    ProxyStub::MethodHandler SessionStubMethods[] = {
       [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            message->Parameters().Implementation<OCDM::ISession>()->Callback(proxy);
    ...
    public:
        ...
        virtual OCDM::ISystem * CreateSystem(
            ...
            // TODO: sync up different ProxyStubs.cpp files
            OCDM::ISystem* result = CreateProxy<OCDM::ISystem>(reader.Number<OCDM::ISystem*>());
    ...
    public:
        ...
        {
        	fprintf(stderr, __FILE__ " In SetServerCertificate of proxy/stub in WPEFrameworkOCDM\n");

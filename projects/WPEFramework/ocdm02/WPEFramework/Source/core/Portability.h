...
namespace Core {
    ...
    enum Error {
       ...
       ERROR_ACCEPT_FAILED = 7,
       ERROR_PENDING_SHUTDOWN = 8,
       ERROR_ALREADY_CONNECTED = 9,
       ERROR_CONNECTION_CLOSED = 10,
       ERROR_TIMEDOUT = 11,
       ERROR_INPROGRESS = 12,
       ERROR_COULD_NOT_SET_ADDRESS = 13,
       ERROR_INCORRECT_HASH = 14,
       ERROR_INCORRECT_URL = 15,
       ERROR_INVALID_INPUT_LENGTH = 16,
       ERROR_DESTRUCTION_SUCCEEDED = 17,
       ERROR_DESTRUCTION_FAILED = 18,
       ERROR_CLOSING_FAILED = 19,
       ERROR_PROCESS_TERMINATED = 20,
       ERROR_PROCESS_KILLED = 21,
       ERROR_UNKNOWN_KEY = 22,
       ERROR_INCOMPLETE_CONFIG = 23,
       ERROR_PRIVILIGED_REQUEST = 24,
       ERROR_RPC_CALL_FAILED = 25,
       ERROR_UNREACHABLE_NETWORK = 26,
       ERROR_REQUEST_SUBMITTED = 27,
       ERROR_UNKNOWN_TABLE = 28,
       ERROR_UNKNOWN_KEY_PASSED = 29,
       ERROR_BAD_REQUEST = 30,
       ERROR_PENDING_CONDITIONS = 31,
    };
}
}

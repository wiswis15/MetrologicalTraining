...
private:
    ...
    class Sink : public OCDM::IAccessor::INotification {
    private:
        Sink() = delete;
    ...
    private: 
        ...
        BEGIN_INTERFACE_MAP(Sink)
            INTERFACE_ENTRY(OCDM::IAccessor::INotification)
        END_INTERFACE_MAP
    private:
...
public:
    ...
    virtual void Register(OCDM::IAccessor::INotification* notification) override {
        _remote->Register(notification);
    }
    virtual void Unregister(OCDM::IAccessor::INotification* notification) override {

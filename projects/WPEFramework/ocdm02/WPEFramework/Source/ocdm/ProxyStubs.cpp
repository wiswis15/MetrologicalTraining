...
namespace WPEFramework {
    ...
    ProxyStub::MethodHandler AccesorStubMethods[] = {
        [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            response.Number(message->Parameters().Implementation<OCDM::IAccessor>()->IsTypeSupported(keySystem, mimeType));
        },
        [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED, Core::ProxyType<RPC::InvokeMessage>& message) {
            //
    ...
    ProxyStub::MethodHandler SystemStubMethods[] = {
        [](Core::ProxyType<Core::IPCChannel>& channel VARIABLE_IS_NOT_USED, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            //
            fprintf(stderr, __FILE__ " In handler for SetServerCertificate\n");
            RPC::Data::Frame::Reader parameters(message->Parameters().Reader());
            RPC::Data::Frame::Writer response(message->Response().Writer());

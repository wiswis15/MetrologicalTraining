...
cmake -DCMAKE_CXX_FLAGS='-m32' -DCMAKE_C_FLAGS='-m32' -DCMAKE_INSTALL_PREFIX=$PREFIX -DCMAKE_MODULE_PATH=$CMAKE_MODULE_PATH -DVIRTUALINPUT=ON -DPORT=8081 $BASE_DIR/repos/Thunder
make -j4
make install
